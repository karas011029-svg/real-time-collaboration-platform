        ...
        >
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground">
              ...
              Revo. Start your 14-day free trial today.
            </p>
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Button
                asChild
                size="lg"
                className="h-12 min-w-40 rounded-full text-base shadow-lg shadow-primary/20 transition-transform hover:scale-105"
              >
                <Link href="/signup">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-12 min-w-40 rounded-full border-border text-base hover:bg-muted/50"
              >
